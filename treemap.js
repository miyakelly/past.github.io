...
// 	parent.document.getElementsByTagName("iframe")[0].setAttribute('style', 'height: 1000px !important');
// }

var margin = {top: 20, right: 0, bottom: 0, left: 0},
    width = 820,
    height = 700 - margin.top - margin.bottom,
    formatNumber = d3.format(",d"), //define the type of output data
    transitioning;
...
var treemap = d3.layout.treemap()
	...
	.round(false);//check what this is, when i comment this the map only shows one square
